...
include("utilitis/config.php");
		...
		$rs_resultforrandom =mysqli_query($conn,"Select * from product where category_id={$category_id} order by rand() limit 9") or die("Error");

		$rs_specialoffer = mysqli_query($conn,"Select * from product where in_sale=1 and category_id={$category_id} order by rand() limit 1 ") or die("Error");
...
<div class="footer">
	...
	<div class="footer1">
		<p>All Rights Reserved | &nbsp; <a href="http://w3layouts.com/"> Developed By Suraj Regmi</a></p>
	</div>
</div>
</div>
</div>
